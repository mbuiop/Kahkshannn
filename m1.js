...
class AdvancedGameEngine {
    ...
    async createAdvancedGround() {
        ...
        // استفاده از تکسچرهای رنگی به جای URL
        ...
        try {
            ...
            console.warn("⚠️ فیزیک زمین قابل فعال‌سازی نیست:", error);
        }
    ...
    async createForest() {
        ...
        this.trees = [];
        const treeCount = 50; // کاهش تعداد برای عملکرد بهتر
    ...
    createWall(x, z, rotation) {
        ...
        try {
            ...
            console.warn("⚠️ فیزیک دیوار قابل فعال‌سازی نیست:", error);
        }
    ...
    createStarterMines() {
        ...
        this.tribeLayout.resources.push(goldMine, elixirMine);
...
console.log("🎮 بازی آماده راه‌اندازی...");
