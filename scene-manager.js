...
class SceneManager {
    ...
    async loadModels() {
        ...
        // در نسخه کامل می‌توان مدل‌های واقعی میوه‌ها را بارگذاری کرد
    ...
    createDepthOfFieldEffect() {
        // در نسخه ساده، این افکت غیرفعال است
        console.log('Depth of Field effect ready');
    }
    ...
    setupExplosionParticles(particleSystem) {
        particleSystem.particleTexture = this.textures.get('particle');
